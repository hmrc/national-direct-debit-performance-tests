...
trait RequestUtils {
  ...
  val bankAccountPage: String       = "/bank-account-details"
  ...
  val paymentPlan: String           = "/tell-us-about-this-payment-plan"
  ...
  val existingPP                  = "/amend-already-have-payment-plan"
  ...
  val selectPaymentFrequency      = "/how-often-want-to-make-payments"
