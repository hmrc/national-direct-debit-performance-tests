...
import uk.gov.hmrc.perftests.requests.SetupDDRequests.{accountNumber, mgdPaymentRef, name, navigateToSetupDDPage, navigateToYourDDIPage, redirectToSplitter, saPaymentRef, sortCode}
