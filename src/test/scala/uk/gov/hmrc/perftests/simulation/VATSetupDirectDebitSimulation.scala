...
trait VATSetupDirectDebitSimulation {
  ...
  setup("setup-direct-debit-journey-vat", "VAT-Setup Direct Debit Journey") withRequests
    (
      ...
      navigateToPaymentOptionPage, choosePaymentOption("vat"),
      navigateToPaymentReferencePage, enterPaymentRefNumber(vatPaymentRef),
