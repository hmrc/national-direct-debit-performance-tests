...
import uk.gov.hmrc.perftests.requests.AmendPaymentPlanRequests.{enterAmendPaymentAmount, landOnSABudgetPPRefPage, navigateToAmendAEndDatePage, navigateToAmendAmountPage, navigateToAmendAmountToBePaidPage, navigateToAmendPaymentPlanPage, navigateToExistingPPQpage, navigateToExistingPaymentPlanCYAPage, navigateToPaymentPlanCYAPage, navigateToPaymentPlanConfirmPage, navigateToPaymentPlanEndDatePage, redirectToSABudgetPPRefPage, submitExistingPPDetailS, submitPaymentPlanDetails, submitPaymentPlanEndDate}
